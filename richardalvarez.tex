...
\usepackage{fontspec}
\setmainfont{AvenirNextLTPro} % Replace with your .otf font file name
...
\section{Work Experience}
  ...
  {IT Assistant}{Sep 2023 - Present}
      \resumeParagraph{Support faculty and staff with technology needs, including equipment preparation and delivery, and office technology moves. securely erasing and recycling outdated equipment, managing public printer support, and updating inventory records. Additionally, I conduct classroom checks and initial troubleshooting, under the guidance of Classroom Support and TSS roles.}
...
\resumeItem{Played a key role in the implementation of web browser extension for HSCHk.}
        \resumeItem{Communicated technical details of HSCHK to team and stakeholders.}
        \resumeItem{Quickly adapted to new technologies and worked collaboratively.}
        \resumeItemListEnd
...
Modeling), OpenCV, Linux,  } \\ \vspace{3pt}
        ...
        \textbf{Applications}{: Davinci Resolve, Adobe Suite, Cinema4D } \vspace{3pt}
    }}
  \resumeSubHeadingListEnd
