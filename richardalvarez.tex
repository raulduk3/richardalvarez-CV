...
\resumeParagraph{I am a seasoned programmer and competitive team leader with 17 unique open-source projects and two published papers on large language models. I am currently exploring VFX, computer rendering, DevOps, Cybersecurity, and Machine Learning. This year, I am a judge for the BDPA High School Competition. My recent work includes developing a full-stack web application to provide tailored GRE flashcards using Next.js and LLMs. Outside my professional pursuits, I enjoy reading, visiting local theaters, and cycling.}
\vspace{2pt}
