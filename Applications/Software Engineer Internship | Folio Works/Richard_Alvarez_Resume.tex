...
\textbf{Technologies}: React.js, Next.js, Tailwind CSS, Redux, Context API, React Native, Git, OpenCV \\ \vspace{2pt}

\textbf{Backend \& Databases}: Node.js, MySQL, MongoDB \\ \vspace{2pt}

\textbf{Development Practices}: Agile, Scrum, CI/CD \\ \vspace{2pt}
...
\resumeCert{CompTIA ITF+}{Sep 2024} \hspace{2pt} {\emph{\small{IT fundamentals, troubleshooting, hardware, networking basics}}}

\resumeCert{NYU Tandon Bridge}{Mar 2025} \hspace{2pt}{\emph{\small{Discrete mathematics, data structures, algorithms, C++ programming}}}
