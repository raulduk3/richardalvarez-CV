...
\resumeParagraph{Provided technical support in a high-demand environment, troubleshooting Windows and macOS issues, configuring printers, and resolving software installation problems. Managed ServiceNow tickets, ensuring timely resolutions. Delivered remote support via remote-in tools.}
...
\resumeSubHeadingListStart
\small{\item{
\textbf{Technical Support}: Windows, macOS, hardware troubleshooting, software installation, peripheral setup, remote support \\ \vspace{2pt}
\textbf{Networking}: Basic understanding of Active Directory, DNS, VPN, network configuration \\ \vspace{2pt}
\textbf{Cloud Services}: Office 365, Google Workspace, email administration \\ \vspace{2pt}
\textbf{Security}: Basic endpoint security, password management, secure data handling \\ \vspace{2pt}
\textbf{IT Operations}: Asset management, system imaging, printer maintenance \\ \vspace{2pt}
\textbf{Development}: Python, JavaScript, C++, SQL, Bash scripting \\ \vspace{2pt}
\textbf{Soft Skills}: Customer service, documentation, troubleshooting, teamwork \\ \vspace{2pt}
}}
