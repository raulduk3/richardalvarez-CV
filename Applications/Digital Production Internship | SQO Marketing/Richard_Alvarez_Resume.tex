...
\begin{center}
	...
	$/$
	\hspace{.5pt} \href{https://www.youtube.com/@lofiricky}{YouTube} \hspace{.5pt}
	$/$
...
\resumeParagraph{I am a film editor and web developer combining experience in filmmaking, computer programming, and visual design to create engaging digital experiences and amplify meaningful stories. I have created over 17 unique open-source projects and authored two papers with over 400 cumulative downloads. I also enjoy reading, listening to music, visiting local theaters, and cycling.}
...
\resumeParagraph{Produced and edited over 15 experimental video projects, including music videos, audio-reactive visualizations, and short films. Authored two papers on machine learning applications in creative industries.}

\resumeParagraph{Relevant coursework includes Senior Seminar in Film (FILM 480), Writing the Short Film (FILM 230), Advanced Post-Production (FILM 391), Elements & Theory of Post-Production (FILM 295), American Film Industry (FILM 191), and Digital Photography (ARTS 321).}
...
\textbf{Video Production}: Adobe Premiere Pro, Cinema4D, DaVinci Resolve \\ \vspace{2pt}
\textbf{Storytelling}: Scriptwriting, Script treatments, Storyboarding \\ \vspace{2pt}
\textbf{Creative Tools}: Adobe After Effects, Blender, Audition \\ \vspace{2pt}
\textbf{On-Set Support}: Camera operation, production assistance, and equipment management \\ \vspace{2pt}
