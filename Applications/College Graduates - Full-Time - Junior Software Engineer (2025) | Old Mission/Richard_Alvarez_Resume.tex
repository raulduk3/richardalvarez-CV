...
\resumeSubHeadingListStart
\small{\item{
\textbf{Programming Languages:} C++, Python, JavaScript, SQL, PHP, Rust \\ \vspace{2pt}
\textbf{Frameworks:} React, Tailwind CSS, Scikit-Learn \\ \vspace{2pt}
\textbf{Systems Knowledge:} Linux, Systems Programming, Data Structures \\ \vspace{2pt}
\textbf{Tools:} Git, Docker, DaVinci Resolve, Adobe Creative Suite \\ \vspace{2pt}
